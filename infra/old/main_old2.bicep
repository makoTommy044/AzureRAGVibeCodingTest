// Azure RAG 環境構築用 Bicep テンプレート (Linux版・再試行)
// 修正内容: Linux 版 App Service (B1) への回帰と構成の最適化
...
var uniqueSuffix = substring(uniqueString(resourceGroup().id, deployment().name, 'v5'), 0, 6)
...
// --- 4. App Service Plan (Linux - B1 Basic) ---
resource appServicePlan 'Microsoft.Web/serverfarms@2023-12-01' = {
  ...
  properties: {
    reserved: true // Linux の場合は true が必須
  }
}
